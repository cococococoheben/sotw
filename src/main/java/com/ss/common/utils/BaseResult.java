...
public class BaseResult<T> {
    ...
    private BaseResult(boolean code, String msg, T data) {
        this.code = code;
        this.msg = msg;
        this.data = data;
    }
    ...
    private BaseResult(boolean code, String msg) {
        this(code, msg, null);
    }
    ...
    public static <T> BaseResult<T> failWithMsg(boolean code, String msg) {
    ...
    public static class ResponseParam {
        ...
        private ResponseParam(boolean code, String msg) {
            this.code = code;
            this.msg = msg;
        }

        public static ResponseParam buildParam(boolean code, String msg) {
