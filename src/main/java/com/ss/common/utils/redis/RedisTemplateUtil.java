package com.ss.common.utils.redis;
...
public class RedisTemplateUtil {
    ...
    public RedisTemplate<Object,Object> getInstance(String string){
     ...
     * @param time 过期时间,秒单位
     */
    public void setForTimeSEC(String key,String value,long time){
     ...
     *
     */
    public Set getKyeNumb(){
        Set<String> keys = stringRedisTemplate.keys("*");
        return keys;
    }
    public Set getKyeNumb(String keyHeard){
        keyHeard=keyHeard+"*";
        Set<String> keys = stringRedisTemplate.keys(keyHeard);
        return keys;
    }
